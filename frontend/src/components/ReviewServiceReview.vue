<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-text>
            ...
            <String label="ReivewContent" v-model="value.reivewContent" :editMode="editMode" :inputUI="''"/>
        ...
        <v-card-actions>
            ...
            <v-dialog v-model="reviewCreateDiagram" width="500">
                <ReviewCreateCommand
                    @closeDialog="closeReviewCreate"
...
<script>
	...
	async created() {
        ...
        methods: {
            ...
            async reviewCreate(params) {
                try {
                    if(!this.offline) {
                        var temp = await axios.put(axios.fixUrl(this.value._links['create'].href), params)
            ...
            openReviewCreate() {
                this.reviewCreateDiagram = true;
            },
            closeReviewCreate() {
                this.reviewCreateDiagram = false;
            },
        },
    }
</script>
