...
pluralCaseList.push( {plural: "orderServices/orders", pascal: "OrderServiceOrder"} )

pluralCaseList.push( {plural: "deliveryServices/deliveries", pascal: "DeliveryServiceDelivery"} )

pluralCaseList.push( {plural: "productServices/products", pascal: "ProductServiceProduct"} )

pluralCaseList.push( {plural: "reviewServices/reviews", pascal: "ReviewServiceReview"} )
